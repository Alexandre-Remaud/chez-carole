...
5. **Verifier le lint** : `pnpm lint` depuis la racine. Corriger toutes les erreurs de lint avant de continuer — ne jamais pusher du code avec des erreurs de lint.
